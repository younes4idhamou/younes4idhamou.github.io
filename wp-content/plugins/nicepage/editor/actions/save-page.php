...
class NpSavePageAction extends NpAction {
    ...
    public static function process() {
        ...
        $headerFooterData = NpSavePageAction::saveHeaderFooter($data_provider, $fullRequest);
        $publishHeaderFooter = $headerFooterData['publishHeaderFooter'];
        $headerFooterDialogs = $headerFooterData['headerFooterDialogs'];
        ...
        if (isset($dialogs) && $dialogs) {
            foreach ($dialogs as $dialog) {
                $modalDialogs .= $dialog['publishHtml'];
            }
        }
        if (isset($headerFooterDialogs) && $headerFooterDialogs) {
            $publishHeaderFooter .= $headerFooterDialogs;
        }

        $data_provider->setStyleCss(_arr($data, 'publishNicePageCss', ''), $publish_html, $publishHeaderFooter, $modalDialogs);
    ...
    public static function saveHeaderFooter($data_provider, $data)
    {
        ...
        return array(
            'publishHeaderFooter' => $publishHeaderFooter,
            'headerFooterDialogs' => $dialogs
        );
    }
}
