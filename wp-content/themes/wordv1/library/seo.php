...
function theme_ld_meta_tags() {
    ...
    $social_links = apply_filters('theme_social_links', array("https://www.facebook.com/ClubSDAD","https://www.instagram.com/club_sdad/","https://www.linkedin.com/company/club-sdad/"));
    ...
    $logo = theme_get_logo(array('default_src' => "/images/logo.png", 'default_url' => ''));
    if (!empty($logo['src'])) {
